\chapter{Carta parisiense I\\ \emph{André Gide e seu novo adversário}\footnote[*]{``Pariser Brief 1. André Gide und sein neuer Gegne'', in
  \versal{GS III}, p. 482-495. Tradução de Carla M. Damião e Pedro H. van Velthen Ramos.}}
...
importantes.\footnote{O debate foi publicado em Paris em 1935 sob o
  título \emph{André Gide et notre temps}. [\versal{N.}~de~\versal{W.B.}]} Ela não havia ainda se
...
juvenil \emph{O retorno do filho pródigo}\footnote{O livro foi
  publicado em tradução alemã de Rilke pela editora Insel. [\versal{N.}~de~\versal{W.B.}]} até o
...
61).\footnote{Essa citação remete a uma avaliação de Gide após seu
  ...
  diretamente seu escrito de 1936, \emph{De volta da \versal{U.R.S.S.}},
  ...
  conduziria para a alegria a minha tristeza''. \versal{[N. E.]}} %Não seria o contrário, mais ela conduziria minha tristeza sobre minha alegria, mais minha tristeza superaria minha alegria? ("plus l'emporterait sur la joie ma tristesse")
...
\emph{Duchoborcy} e comentado de forma menos depreciativa sobre a arte. %nota sobre Duchoborcy?
...
e nos campos exercício em frente do \emph{Führer}. Então, pode"-se %campos de exercício?
...
Maulnier considera que esta posição está tão fundamentada que ele não
tem escrúpulos em citar, como uma curiosidade, as frases com as quais
Maiakóvski ocupa"-se com a visão de Marinetti da máquina. Maiakóvski fala
...
Essas são as massas, e as massas que leem. ``Através dos esforços
...
acaricias é meu próprio desejo, hoje!'' (\emph{Nouvelles nourritures}, p. \enlargethispage{\baselineskip}
