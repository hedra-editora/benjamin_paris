...
literatura alemã.\footnote{O contexto da carta de Gershom Scholem a
  Benjamin (Walter Benjamin, \emph{Gesammelte Briefe}, vol. \versal{I}. Organização de Gershom
  Scholem e Theodor W. Adorno. Frankfurt a. \versal{M}.: Suhrkamp, 1978, p.~511), enviada de Jerusalém e datada de 20 de fevereiro de 1930, alude à ambição de
...
produtor''\footnote{Título de uma suposta ``Conferência pronunciada no
  ...
  Estudo do Fascismo. Cf. Walter Benjamin, \emph{Gesammelte Schriften}, vol.\,\textsc{ii}-3. Frankfurt a.\,\textsc{m}.: Suhrkamp, 1991, p.\,1460--1463.} e das ``Cartas parisienses \versal{I} e \versal{II}''\footnote{Cf.
...
entanto, apesar de conhecer o \emph{Diário de volta da \versal{URSS}}, não
...
partido comunista quando, de volta de sua visita à \versal{URSS}, passa a
discordar do encaminhamento do comunismo via stalinismo e publica duas
obras: \emph{Retour de l'\versal{URSS}} de 1936 e \emph{Retouches à mon
Retour de l'\versal{URSS}} em 1937, ambas publicadas pela editora Gallimard.
...
mourir}''.\footnote{J.-P. Sartre. ``Gide vivant''. In: \emph{Situations, \versal{IV}}. Paris: Gallimard, 1964, p.\,75--79.}

Essas críticas transitam do pessoal à obra e, às vezes, a própria obra
...
``A vocação de Gide'' e ``Cabeças parisienses'', exemplos desse tipo de produção midiática. A ``Carta parisiense \versal{II}'', ainda nesse âmbito, pouco estudada em comparação
...
Os textos desta coletânea apresentam uma estreita e tensa relação entre
...
As traduções dos textos desta coletânea, em parte inéditos em língua
