...
dessas. Da entrevista com Gide realizada em 1929, vertida em dois textos %1928, como aparece na nota de rodapé?
diferentes,\footnote{Da entrevista com Gide realizada por Benjamin em
  ...
  17/2/1928.} ao ``Diário de %Diário parisiense, como aparece no sumário?
Paris'', do final de 1929 a junho de 1930, o interesse é marcado pela %O interesse é marcado pela preocupação, frase estranha...
...
estudos sobre Proust e Gide.\footnote{L. Pierre"-Quint. \emph{Marcel
  Proust. Sa vie, son \oe uvre}. Paris: Éditions du Sagitaire; %Ano?
  \emph{Comment travaillait Marcel Proust}. Paris: Éditions des Cahiers Libres,
1928; \emph{André Gide. Sa vie, son \oe uvre}. Paris: Éditions %Outra edição do que a da nota anterior realmente?
...
André Gide e seu novo adversário''. %Título aparece diferente no sumário, será uma questão?
...
se vê forçado a enfrentar em seu estilo.\footnote{Elisabetta Villari. ``Introduzione''. %estilo mesmo? ou exílio?
...
de alguns artigos. Reciprocidade demonstrada por Benjamin ao sugerir a %Achei a frase um pouco solta
...
no terreno literário entre Alemanha e França?\footnote{Essa entrevista
  ...
  allemande: la recontre avec Walter Benjamin en 1928'', \emph{Bulletin des amis d'André Gide}, vol.~\versal{VII}, n.~44, octobre, 1979. Foucart é especialista em Gide e na relação
  ...
  Benjamin und der deutsch"-französische Dialog''. In: \versal{JÄGER}, L./\versal{REGEHLY}, T. (org.). \emph{Was nie geschrieben wurde, lesen}. Bielefeld:
  ...
  franco"-germânico. Citamos ainda um terceiro intérprete, Michael Lucey. %É necessário aqui fica elencando bibliografias que já apareceram em outras partes da introdução?
