...
\linhalayout{coordenação científica e editorial da Coleção W.Benjamin}{Amon Pinho}
\linhalayout{supervisão técnica e de tradução}{Francisco Pinheiro Machado}


%{\tiny
%\hspace*{-6pt}\begin{tabular}{ll}    
%\textbf{revisão de tradução} & Francisco Pinheiro Machado\\
...
%\linhalayout{preparação de originais}{Amon Pinho}}
...
\ifdef{\organizador}{{\small {\organizador} (\textit{organização e tradução})} \par}{}
\ifdef{\introdutor}{{\small {\introdutor} (\textit{introdução})} \par}{}\vspace{1.5cm}
%\ifdef{\tradutor}{{\small {\tradutor} (\textit{tradução})}\par}{}\vspace{1.5cm}
\vspace{7pt}

{\baselineskip=0.7\baselineskip \footnotesize 

\textsc{direção da coleção w.benjamin%científica e editorial 
}\\
Amon Pinho\\
Francisco Pinheiro Machado\par}
\medskip
...
% Resumo -------------------------------------------------------
\begingroup \footnotesize \parindent0pt \parskip 5pt \thispagestyle{empty} 
