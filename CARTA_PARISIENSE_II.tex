...
está no fundo desta divisão do trabalho é o desaparecimento da
...
da \emph{Nouvelle Revue Française}.\footnote{\emph{Nouvelle Revue
  Française} -- \versal{NRF} (1909-) é revista de cunho literário e
...
photographie en France au dix"-neuvième siècle}\footnote{Gisèle Freund,
  ...
  1934, 2, série I6, p. 306. [\versal{N.}~de~\versal{W.B.}]} apresenta a ascensão da fotografia em
...
em questão, pois ao mesmo tempo por meio da reprodução força seu
