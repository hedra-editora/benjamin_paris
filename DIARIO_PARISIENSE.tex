...
\emph{flic}:\footnote{Louis Aragon (1897-1992) escreveu
  ...
  vendedor de frutas e vegetais, e \emph{flic} é o policial. \versal{[N. E.]}} todas
...
foi menos movimentada, não menos cheia de atos violentos do que outra. %nem menos cheia?
...
da ideia de personalidade que a literatura recente conhece. ``Frague'', %O nome é propositalmente grafado errado, certo?
...
pouco esta palavra para abarcar o essencial. Na realidade, Giraudoux
...
Anfítrion. Aceitemos que a moral, que se insinua tão virtuosa e sedutora %Anfítrion mesmo, não seria Amphitryon?
...
alguns membros dissidentes do grupo, que eu recém"-adquirira: ``eles são %manter a aspas em francês, como em "Cabeças parisienses"?
...
jovens em nenhuma contraposição com sua admirável \emph{franchise}. Em %adicionar nota à franchise?
...
atrás do balcão ou da bilheteria --- em resumo um \emph{arrangement} de %nota trad.?
esponjas de banho, perfumes, \emph{pochettes surprise}, bilhetes para %nota trad.?
...
Albert, o \emph{Bal des trois colonnes}. Por algum momento, talvez %nota trad.?
...
depois que eles se conheceram, equipou para ele uma \emph{Maison de %nota trad.?
...
Félix Bertaux. Apesar de sua aparência sulista, %Nota sobre Félix Bertaux?
...
é muito esperado. Nossa conversa girou sobretudo em torno a Proust. %em torno de Proust
...
forçar esta situação no canto da mesa, temo também de estar atrapalhando %temo também estar? sem o "de"
...
monde que de la vie même}.\footnote{Em francês no original: ``O reverso --- menos do mundo do que a própria vida''. \versal{[N. T.]}} %não seria melhor "do que da própria vida"?
