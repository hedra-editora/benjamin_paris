...
\emph{flic}:\footnote{Louis Aragon (1897--1992) escreveu
  \emph{Le paysan de Paris} (\emph{O camponês de Paris}) no momento em que André Breton 
  escrevia o seu \emph{Manifeste du surréalisme}. A descrição
  minuciosa de \emph{Passage de l'Opéra}, uma das passagens parisienses
  alinhadas com restaurantes e pequenas lojas, é um documento"-chave do
  ...
  a Benjamin, que se refere a isso repetidamente no início de
...
parede, empilhados sobre a mesa de cabeceira. Ele não evocou apenas esse Proust,
...
Halévy.\footnote{Paul"-Louis Courier (1772--1825) foi um panfletário
  francês irônico e inventivo. Foi um oponente ardoroso da
...
jovens, em nada contraposto à sua admirável \emph{franchise}.\footnote{Em francês no original: franqueza. [\versal{N.~T.}]} Em
...
tópico de conversa é \versal{IMS};\footnote{\versal{IMS} era o pseudônimo sob o
...
de escrever uma \emph{Défense du soleil}.\footnote{Em francês no original: ``Defesa do sol''. {[}\versal{N.~T.}{]}} Entramos em uma reflexão sobre os
...
Antes disso, um passeio de despedida pelos \emph{Champs-\\-Élysées}. A superfície
