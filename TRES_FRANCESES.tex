\chapter{Três franceses\footnote[*]{``Drei Franzosen'',
  ...
  Tradução de Carla Milani Damião e Pedro Hussak. Essa resenha
...
nova literatura francesa, ao redor do qual Souday,\footnote{Walter
  ...
  {[}\versal{N.~O.}{]}} com sua pena crítica, traçou um círculo, tornando"-o assim
...
Julian Hirsch,\footnote{Benjamin refere"-se à obra de Julian Hirsch,
  ...
  1914. {[}\versal{N.~O.}{]}} ainda esteja por ser escrita, aquilo que se mostra
...
intelectual do tempo, esse olhar reconheceu a tempestade de poeira
...
Mas, certamente, a quem ele abre"-se (cada frase pode tornar"-se a fresta
...
(\emph{dompteur ès lettres}).\footnote{Segundo o organizador Heinrich
  ...
  Gesamtausgabe}, vol.\,13.2. Berlim: Suhrkamp, 2011, p. 86--88), o próprio Gide se referia a Baudelaire como ``Magicien ès lettres françaises'', certamente em referência à dedicatória inicial de \emph{As flores do mal} de Baudelaire ao poeta Théophile Gautier: ``Au poète impeccable/Au parfait magicien ès lettres françaises\ldots{}''. [Ao poeta impecável/ ao perfeito mágico das letras francesas/ a meu caríssimo e veneradíssimo/ mestre e amigo/ Théophile Gautier/ com os sentimentos/ da mais profunda humildade/ dedico/ estas flores doentias (tradução de Ivan Junqueira)]. [\versal{N.~O.}]}
...
rugido\footnote{Em alemão, \emph{Das Grollen} pode significar o
  ...
  (\emph{ibidem}, p.~102) é voltado para a reação da opinião pública diante da
  ...
  também ser uma reação, de ordem política, à publicação de \emph{Voyage
  au Congo}, em 1927, embora esta obra não esteja citada na resenha em
  questão. {[}\versal{N.~O.}{]}} por toda Paris, que acabou arruinando alguns
...
público aumentava, que então um abade\footnote{Benjamin refere"-se aqui
  ...
  algumas décadas na França, em parte motivado pelos três livros do
  abade --- \emph{La poésie pure} (1925--1926), \emph{Prière et poésie}
  (1926), \emph{Racine et Valéry} (1930) ---, e pela proposição de que toda
  poesia advém do divino. {[}\versal{N.~O.}{]}} um tanto espirituoso se
...
polêmica. E se, assim, afasta"-se dos tipos medianos da crítica francesa,
