...
(\emph{dompteur ès lettres}).\footnote{Segundo o organizador Heinrich
  ...
  Gesamtausgabe}, volume 13.2, p. 86--88). O próprio Gide se referia a Baudelaire como ``Magicien ès lettres françaises'', certamente em referência à dedicatória inicial de \emph{As flores do mal} de Baudelaire ao poeta Théophile Gautier: ``Au poète impeccable/Au parfait magicien ès lettres françaises\ldots{}''. [Ao poeta impecável/ ao perfeito mágico das letras francesas/ a meu caríssimo e veneradíssimo/ mestre e amigo/ Théophile Gautier/ com os sentimentos/ da mais profunda humildade/ dedico/ estas flores doentias (tradução de Ivan Junqueira) \versal{N.~O.}].}
