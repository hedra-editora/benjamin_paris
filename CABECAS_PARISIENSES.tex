...
\begin{quote} %seria revolucionário, certo?
...
alteza imperial ou principesca ``\emph{C'était ma première altesse}'' %ele traz a tradução em alemão no original? A tradução mais precisa não seria, "Era minha primeira..."?
...
de maneira excelente e ouvir a agradável inflexão com o qual ele evocava %com a qual?
