\chapter{Cabeças parisienses\footnote[*]{\versal{GS VII}-1, p.
...
intitulou sua autobiografia de \emph{Paris vécu},\footnote{Em francês no original: Paris
  vivida. [\versal{N. E.}]} baseada não em um esquema cronológico,
...
\emph{Gare Montparnasse}. O bairro que, aliás, que deu asilo a Lenin por anos
...
bourgeoise}.\footnote{Em francês no original: ``Morte ao pensamento burguês''.} Se a produção ensaística francesa possui uma relevância na Europa, e seus escritos críticos sobressaem"-se tanto
...
conhecido como \emph{Théatre de la monnaie}.\footnote{Em francês no original: Teatro da moeda. [\versal{N. T.}]} O seu interior preserva seu caráter
...
\emph{Bœuf sur le toit},\footnote{Em francês no original: Carne no telhado.} depois veio o \emph{Grand écart}\footnote{Em francês no original: Grande lacuna. [\versal{N. T.}]} e o mais novo é
...
moda é que as \emph{Boîtes de nuit}\footnote{Em francês no original: clube noturno. [\versal{N. T.}]} sejam mantidas pelas damas da aristocracia.
