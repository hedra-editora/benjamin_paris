\movetooddpage
\addcontentsline{toc}{chapter}{\normalsize\textsc{marcel proust}}
\part*{Marcel Proust}

\chapter{Imagem de Proust\footnote[*]{``Zum Bilde Prousts'', in \versal{GS II}-1, p. 310--324. Tradução de Carla Milani Damião. Ensaio publicado pela primeira vez em 1929 na revista \emph{Die literarische Welt}. A tradução é da versão datada de 1934. Benjamin foi o primeiro autor alemão contratado para traduzir a obra de Proust, tendo publicado, em 1927, \emph{À sombra das moças em flor} e, em 1930, \emph{O caminho de Guermantes}. A tradução do volume \emph{Sodoma e Gomorra} não foi encontrada. [\versal{N.~O.}]}}
...
uma vida como aquele que a viveu lembra\footnote{Traduzimos
  ...
  instaura na tecedura ou confecção de imagens literárias que se
...
Quando os romanos denominam um texto tecedura, quase nenhum outro, assim
...
\emph{esprit d'Oriane},\footnote{O \emph{esprit d'Oriane} é descrito como o principal
  atrativo do Salão dos Guermantes. Cf. Marcel Proust, \textit{Le Côté de Guermantes}.
  Paris: Gallimard, 1994, p.\,438. \versal{[N.~O.]}} ele próprio havia familiarizado"-se
no contato com os Bibescos\footnote{Cf. nota 1 de ``Proust"-Papiere. Documentos sobre Proust'', p.\,\pageref{bibescos}. {[}\versal{N.~O.}{]}} com a improvisação de uma linguagem cifrada,
