\chapter{O comerciante no poeta\footnote[*]{``Der Kaufmann im Dichter'', in \versal{GS} \versal{III}, p.~46--48. Tradução de Carla Milani Damião. Resenha originalmente publicada na revista \emph{Die literarische Welt} em 15 de outubro de 1926. [\versal{N.~O.}]}}
...
regateando e pechinchando alguns tostões a mais ou a menos.}{\textsc{sterne}, \emph{Tristram Shandy}, \versal{I}, 9.\footnotemark}
...
\footnotetext{A passagem, no texto original em inglês, não corresponde integralmente à
  ...
  not come off the better by it.'' Laurence Sterne. \emph{The Life and
