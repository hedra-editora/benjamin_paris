\chapter{O comerciante no poeta\footnote[*]{\versal{\emph{GS}} vol. \versal{III}, p.~46-48. Tradução de Carla Milani Damião a partir do
...
littéraires} presentées par Pierre Mac Orlan'').\footnote{Trata"-se do %Não tem itálico o resto da frase mesmo, ...presentées par Pierre Mac Orlan?
