\chapter{Paul Valéry -- Em seu sexagésimo aniversário\footnote[*]{``Paul Valéry. Zu seinem 60. Geburtstag'', in \versal{GS II}-1, p. 386--390. Tradução de Carla Milani Damião. Originalmente publicado na revista \emph{Die literarische Welt} em 30 de outubro de 1931. Como ocorre em outros textos publicados nesse volume, partes desse ensaio compõem um outro mais extenso, intitulado ``O lugar social do escritor francês na atualidade''. [\versal{N.~O.}]}}
\hedramarkboth{Valéry em seu aniversário}{}

%\epigraph{\emph{O langage chargé de sel, et paroles véritablement marines!}}

\begin{flushright}
{\footnotesize\emph{O langage chargé de sel, et paroles\\ véritablement marines!}}\footnote[\dag]{Em francês no original: ``Ó linguagem carregada de sal e palavras verdadeiramente marinhas!'' [\versal{N.~T.}]}
\end{flushright}
...
letrado\footnote{Benjamin refere"-se ao famoso discurso do Abade
  ...
  1925, em torno da ideia de \emph{poésie pure} (In: \versal{BREMOND}, \emph{La
...
mar da voz. É isso que separa essa poesia reflexiva\footnote{No original em alemão: \emph{Gedenkenlyrik}. [\versal{N.~T.}]}
