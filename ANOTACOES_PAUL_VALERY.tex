...
\chapter[Anotações para o ensaio sobre Paul Valéry \medskip]{Anotações para o ensaio\\ sobre Paul Valéry\footnote[*]{``Ein Blatt mit Brouillons zu dem Aufsatz Paul Valéry'', in \versal{GS II}-3, p. 1145--1146. Tradução de Carla Milani Damião. Os
  ...
  Benjamin'' (p.~1145). Trata"-se de uma folha de anotações avulsa, relativa ao ensaio sobre Valéry. [\versal{N.~O.}]}}
\hedramarkboth{Anotações para o ensaio}{}
