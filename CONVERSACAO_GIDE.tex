\chapter{Conversação com André Gide\footnote[*]{\versal{GS IV}-1, p. 502-509. Tradução de
  Carla Milani Damião.}}
...
\footnote{Em latim no original: ``portador de todas suas coisas consigo''. \versal{[N. T.]}} em
...
(\emph{Interview}),\footnote{\emph{Interview} no texto original.
  ...
  \emph{Gesammelte Schriften}, volume \versal{II}(1), p. 91-96. \versal{[N. T.]}} uma forma que diplomatas, economistas, gente de cinema, criaram
...
théatre c'est un terrain banal}''.\footnote{Em francês no original: ``O teatro é um terreno banal''. \versal{[N. T.]}}
...
livro alemão, \emph{As afinidades eletivas}.\footnote{Gide
  ...
  a respeito desse encontro (Cf. \emph{Walter Benjamin, \versal{GS VII},
