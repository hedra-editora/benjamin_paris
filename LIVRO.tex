\documentclass[showtrims,trimframe,compontinhos,12pt,spreadimages]{memoir}
...
\hyphenation{auto-bio-grafia}
\hyphenation{dia-loga}
\hyphenation{Champs-Ély-sées}
\hyphenation{auto-imersão}
\hyphenation{político-artístico}
\hyphenation{inquiéteur}
