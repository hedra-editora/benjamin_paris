...
\chapter*{Proust-Papiere\\ \emph{Documentos sobre Proust}\footnote[*]{``Proust-Papiere'', in \versal{GS II}-3, p. 1048--1065. Tradução de Carla Milani Damião. Documentos, anotações ou materiais sobre o ensaio ``Imagem de Proust''. Segundo os editores alemães (\versal{GS II}-3, p.~1047), a maior parte desses documentos foi encontrada num envelope, no dorso do qual se lia: ``Proust"-Papiere''. Os textos foram editados na ordem em que se encontravam, contendo algumas repetições, correções e reescritas de trechos. Importante observar que nesse agrupamento de textos é notável perceber que os editores mantiveram, dos manuscritos, inúmeras exclusões de trechos riscados pelo próprio Benjamin. O uso de chaves \{\} sinaliza quais são os trechos. Ao final de cada manuscrito, a sigla ``Ms'' indica o número do manuscrito no arquivo de origem, à época dessa edição: Benjamin"-Archiv Theodor Adorno, sediado em Frankfurt a.\,\versal{M}., atualmente no Walter Benjamin"-Archiv, Akademie der Künste, em Berlim. Há também o uso de colchetes [] para eventuais comentários dos editores relativos a irregularidades nos textos. [\versal{N.~O.}]}}
\addcontentsline{toc}{chapter}{Proust-Papiere \medskip}
\hedramarkboth{Proust-Papiere}{}

\section{Materiais preparatórios do~ensaio~sobre~Proust}


\noindent{}\{Em conexão com o relacionamento íntimo de Proust com os Bibescos, sua
linguagem secreta,\footnote{A linguagem secreta refere"-se, por exemplo, \label{bibescos}
  ao uso de palíndromos com os nomes próprios: Marcel era Lecram
...
natureza deveriam ser banidam; por isso, para ele, até no amor as ligações
pervertidas\footnote{No ensaio ``Imagem de Proust'', a expressão
  ``ligações pervertidas'' (\emph{die pervertierten Bindungen}) é substituída por ``ligação invertida'' (\emph{die invertierte Bindung}). \versal{[N.~O.]}} eram mais úteis do que as normais. Em algum
...
{[}acrescentado posteriormente{]}:\footnote{Observação dos editores
  alemães Tiedemann e Schweppenhäuser, \versal{GS II}-3, p.\,1049. \versal{[N.~O.]}} e
...
(A observação reveladora é da duquesa Cl{[}ermont"-Tonnerre{]}, de que na
...
daquilo que o ocupou ao lado de sua obra principal, como
...
tratada respectivamente no estilo de Balzac, Flaubert, Sainte"-Beuve,
...
criativa na forma de uma paródia. A capacidade mimética e a crítica não
...
não apenas viver mais tempo com suas personagens, Madame de Beauséant ou
Frédéric Moreau, mas até mesmo nossa voz interior quer continuar a falar
...
Um ano e meio depois, \emph{À propos de Baudelaire}, escrito na elevada altura da fama e na baixa altura do leito de morte, cai de modo surpreendente, e certamente também de modo maravilhoso, em seu acordo maçônico, no sofrimento, nas suas \emph{défaillances de la
mémoire},\footnote{Em francês no original: falhas de memória. \versal{[N.~T.]}} com a tagarelice daquele que repousa, com o \emph{détachement}\footnote{Em francês no original: desprendimento. \versal{[N.~T.]}} em relação ao tema levado ao extremo daquele que quer falar mais uma vez ainda, não importa sobre o quê. E como esta exaustão é entretecida em
...
sufocante. A estilística fisiológica levaria ao âmago dessa obra. {[}({]}\footnote{Parêntese aberto e não fechado por Benjamin ou pelos
...
lembranças pelas quais procuramos aparece como imagens visuais à nossa
...
\emph{unwillkürlichen Eingedenkens}. \versal{[N.~T.]}} na qual os momentos de
...
no ocorrido {[}sic{]}\footnote{No original, a frase está incompleta,
  dificultando a compreensão. Verificar a imagem completa em ``Imagem de Proust''. \versal{[N.~T.]}}  do pescador no mar do \emph{Temps
...
Proust Swann \versal{I} 13\footnote{Anotação do próprio texto. {[}\versal{N.~T.}{]}} -- sobre o aspecto cinematográfico de seu trabalho.
...
desempenho literário quanto na relação que uma aristocrata como a
...
como em Proust em que lugar de sua obra se localiza o que antes dele não
...
quanto poder"-se"-ia ganhar por meio da característica do homem, se não um
...
``papier fait exprès à Londres''.\footnote{Em francês no original: ``papel feito intencionalmente em Londres''. \versal{[N.~T.]}} {[}Clermont"-Tonnerre{]} Montesquiou, op.~cit.
...
\emph{Côté de Guermantes} \versal{I}

Proust também achou uma das maiores fórmulas do amor: ``posséder à lui
seul les désirs d'une femme''\footnote{Em francês no original:
  ``Possuir por si só os desejos de uma mulher''. \versal{[N.~T.]}}
...
\begin{flushright}
\emph{\footnotesize{Cópia do original: Arquivo Benjamin,\\ Ms 431, \versal{GS II}-3, p. 1060.\footnote{A expressão ``Repertório de personagens'' figura em francês no original: ``Répertoire des personnages''. [\versal{N.\,T.}]}}}
\end{flushright}

A cerimonisidade\footnote{No manuscrito Ms 438, lê"-se \emph{Prousts
  Umständlichkeit}. Na edição de Tiedemann e Schwenppenhäuser, lê"-se:
  \emph{Prousts Unverständlichkeit}. Traduzimos \emph{Umständlichkeit} por
...
Clermont"-Tonnerre faz a observação reveladora de que na obra de Proust não
...
\{Montesquiou compara a obra de Proust com o desfile dos insetos naquele romance de
Salomão.\}
...
finalmente também Proust, basicamente, eram apenas bons o suficiente para
...
estilo da autora {[}provavelmente Elisabeth de Clermont"-Tonnerre{]}\footnote{Observação dos editores Tiedemann e
  Schweppenhäuser, p. 1062. \versal{[N.~O.]}} Predominância da literatura biográfica e
...
\section{{[}Notas sobre Proust e Baudelaire{]}\protect\footnote[*]{\uppercase{A}ntecedendo estes
  ...
  (\versal{GS II}-3, p. 1062) a respeito do material --- \textit{\uppercase{P}rolegomena} ---
  ...
  `\uppercase{I}magem de \uppercase{P}roust'. \uppercase{E}m `\uppercase{P}rolegômenos para \uppercase{P}roust
  \versal{II}', o significado do \versal{II} não é claro: o mais improvável é que isto
  quer dizer prolegômenos sobre o segundo volume da `\emph{\uppercase{R}echerche}';
  ...
  trabalho preparatório para o ensaio de 1929 (o `\uppercase{P}rolegômenos \versal{I}' estaria,
...
O envelhecimento como processo terrível no cosmos da semelhança

Este cosmos torna acessível as \emph{correspondances} de Baudelaire
...
{[}Robert{]} Dreyfus destacam, com razão, o tom epistolar que tem toda
...
decifrada{]},\footnote{Observação dos editores Tiedemann e
  Schweppenhäuser, \versal{GS II}-3, p. 1065. \versal{[N.~O.]}} do que suas análises
